...
public class IRBinOp extends IRExpr {
    ...
    public Iterable<IRNode> children() {
        return Arrays.asList(new IRNode[] { left, right });
    }

    // TODO
//    @Override
//    public int computeMaximumCallArguments() {
//        int l = left.computeMaximumCallArguments();
//        int r = right.computeMaximumCallArguments();
//        return Math.max(l, r);
//    }
//
//    @Override
...
//        if (!(object instanceof IRBinOp)) return false;
//        IRBinOp other = (IRBinOp) object;
//        return other.left.equalsTree(left) && other.right.equalsTree(right);
//    }
//
//    @Override
...
//        code = 37 * code + left.treeHashCode();
//        code = 37 * code + right.treeHashCode();
//        return code;
//    }
//
//    public ASTNode visitChildren(NodeVisitor v) {
//        IRExpr left = (IRExpr) v.visit(this, this.left);
//        IRExpr right = (IRExpr) v.visit(this, this.right);
//
//        if (left != this.left || right != this.right)
...
//        return new IRBinOp(type,
//                           (IRExpr) left.deepCopy(),
//                           (IRExpr) right.deepCopy());
//    }
//
