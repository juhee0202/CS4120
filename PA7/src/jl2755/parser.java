...
public class parser
 extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\004\000\002\002\006\000\002\003\003\000\002\003\005" +
...
class CUP$parser$actions {
    ...
    public final java_cup.runtime.Symbol CUP$parser$do_action_part00000000(
        ...
        /*. . . . . . . . . . . . . . . . . . . .*/
        case 3: // array_element ::= dotable_expr DOT identifier indexed_brackets 
            {
                ArrayElement RESULT = null;
                ...
                int ibright = CUP$parser$stack.peek().right;
                IndexedBrackets ib = CUP$parser$stack.peek().<IndexedBrackets> value();
                 RESULT = new ArrayElement(new DotableExpr(de,id),ib); 
                CUP$parser$result = parser.getSymbolFactory().newSymbol("array_element",0, CUP$parser$stack.elementAt(CUP$parser$top-3), CUP$parser$stack.peek(), RESULT);
            }
            return CUP$parser$result;
